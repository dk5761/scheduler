...
class AppRouter extends _i3.RootStackRouter {
  ...
  final Map<String, _i3.PageFactory> pagesMap = {
    ...
    NewSchedule.name: (routeData) {
      return _i3.MaterialPageX<dynamic>(
          routeData: routeData, child: const _i2.NewSchedule());
    }
  };
...
/// generated route for
/// [_i2.NewSchedule]
class NewSchedule extends _i3.PageRouteInfo<void> {
  const NewSchedule() : super(NewSchedule.name, path: '/newSchedule');
